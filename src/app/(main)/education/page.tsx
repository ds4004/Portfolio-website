        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-primary-600">Bachelor of Technology in Computer Science and Engineering</h3>
            </div>
            ...
            <div className="space-y-2">
              <h4 className="font-semibold text-dark-900">Relevant Courses:</h4>
          ...
          >
            <div className="flex items-center space-x-3 mb-4">
              <Icon icon="mdi:school" className="text-primary-600" width={24} height={24} />
              <h3 className="text-xl font-bold text-primary-600">Senior Secondary (12th Grade) - Science</h3>
            </div>
            <p className="text-gray-600 mb-4">
            ...
            <div className="space-y-2">
              <h4 className="font-semibold text-dark-900">JEE Achievements:</h4>
              <ul className="space-y-1 text-sm text-gray-600">
